...
<section class="rel max-w-4xl mx-auto px-6 py-24" id="terms">
  ...
  <div class="glass p-8 md:p-10 space-y-8 text-sm text-slate-300 leading-relaxed reveal">
    <div>
      ...
      <p class="mt-2"><strong class="text-slate-200">Обязанности Заказчика:</strong> не создавать запрещённый контент (включая контент, нарушающий авторские права, содержащий персональные данные третьих лиц без их согласия, экстремистские материалы или иной контент, запрещённый законодательством РФ), не передавать доступ третьим лицам.</p>
      ...
      <p class="mt-2"><strong class="text-slate-200">Ограничение ответственности:</strong> Исполнитель действует как информационный посредник (ст.&nbsp;1253.1 ГК&nbsp;РФ) и предоставляет техническую возможность генерации контента по запросу Заказчика. Заказчик несёт полную ответственность за содержание своих запросов и сгенерированного контента, включая соблюдение авторских прав, прав на изображение третьих лиц и действующего законодательства РФ. Исполнитель не несёт ответственности за пользовательский контент в соответствии с ФЗ&#8209;149 «Об информации» и вправе удалить контент, нарушающий права третьих лиц, в порядке ст.&nbsp;15.7 ФЗ&#8209;149.</p>
