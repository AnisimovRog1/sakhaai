...
function FullscreenViewer({ tpl, lang, onClose, onUse, useLabel }: {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black" onClick={onClose}>
      ...
      {/* Кнопка закрытия */}
      <button
        className="absolute z-20 w-11 h-11 rounded-full bg-black/60 backdrop-blur-md flex items-center justify-center border border-white/25 active:scale-90 transition-transform" style={{ top: 'calc(var(--safe-top, 0px) + 52px)', right: '16px' }}
