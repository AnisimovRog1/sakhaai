...
const KL = (hash: string, w = 720, h = 1280) => `https://s15-kling.klingai.com/kimg/EMXN1y8q${hash}:${w}x${h}.webp?x-kcdn-pid=112372`;
...
// ═══════════════════════════════════════════════════
// VIDEO — Текст в видео (постеры реальных Kling-генераций)
// ═══════════════════════════════════════════════════
export const VIDEO_TEMPLATES: VideoPromptTemplate[] = [
  ...
  { id: 'v-cine-01', tab: 'video', category: 'cinematic',
    ...
    label: { ru: 'Фигурное катание', sah: 'Фигурнай тэгүллүү' } },
  { id: 'v-cine-02', tab: 'video', category: 'cinematic',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJZmQ4MDZkYTgtNzhhOC00MjBkLTk1ODAtODdiZTg2ZjIxMWRlLWN0WW4zRC1jQ0tjZkVMdlh0NHJzM1Etb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Молодая девушка с длинными каштановыми волосами медленно поворачивается к камере на фоне заката в поле пшеницы. Золотой час, тёплый контровой свет, лёгкий ветерок. Крупный план лица, мягкая улыбка, солнечные блики на волосах. Кинематографическая малая глубина резкости, цветокоррекция в тёплых тонах, стиль независимого кино',
    label: { ru: 'Портрет на закате', sah: 'Киэһээҥи портрет' } },
  { id: 'v-cine-03', tab: 'video', category: 'cinematic',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJNmVjMjdhOGQtZDRmZi00MmRlLWEyN2UtMTM3ZTgyMDA3ZDFiLXVuak05MHF6Znlxd0d2Vkl4TFBEVHctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Мужчина в тёмном костюме стоит на крыше небоскрёба, ветер развевает полы пиджака. Ночной город сияет огнями внизу. Камера медленно облетает вокруг, открывая панораму мегаполиса. Дождевые капли на стекле, неоновые отражения. Кинематографический широкий план, стиль нуар, синяя и оранжевая цветокоррекция',
    label: { ru: 'Ночной город', sah: 'Түүн куорат' } },
  { id: 'v-cine-04', tab: 'video', category: 'cinematic',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMjNkNWNlMmUtZGRlMS00ZGQyLTkyZjktMTAzMGJkNDQ4M2UwLXRTUGM5b0hteXcwRVRaRFFQdWE5YlEtb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Пара танцует медленный танец в пустом бальном зале с хрустальной люстрой. Мягкий рассеянный свет, пылинки в воздухе. Камера медленно отъезжает, показывая масштаб зала. Элегантное вечернее платье развевается при вращении. Романтическая кинематография, стиль «Ла-Ла Ленд», тёплая золотая палитра',
    label: { ru: 'Танец в зале', sah: 'Зал иһигэр тэгүллүү' } },

  // ─── Экшн ───
  { id: 'v-act-01', tab: 'video', category: 'action',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMmJmYTRiYjYtOTBjZC00ZjlmLThiZGItYzBjZmQ4YzQyNTBlLUNwYkh2Wkl1WUx4NmJ5WkJ5bXZ5M3ctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Паркурщик бежит по краю крыши многоэтажки, совершает прыжок через пропасть между зданиями. Камера летит следом в стиле FPV-дрона. Замедленная съёмка в момент полёта, затем ускорение при приземлении. Городские крыши, утренний туман, контровой солнечный свет. Динамичная спортивная кинематография',
    label: { ru: 'Паркур на крышах', sah: 'Паркур ыраас үрдүгэр' } },
  { id: 'v-act-02', tab: 'video', category: 'action',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJNTAzZGE4Y2UtMDgwMi00ODc0LTk4ODctYjkxYTlkYTc3YjViLTNtUEI1eDA4SVVWbkFJT0xWNzZzQ2ctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Сноубордист летит по свежему пухляку в горах, за ним шлейф снежной пыли. Вид от первого лица, затем переключение на боковую камеру. Яркое солнце, голубое небо, белоснежные склоны. Замедленная съёмка прыжка с трамплина, захватывающий полёт. Экстремальная спортивная съёмка, GoPro-эстетика',
    label: { ru: 'Сноуборд в горах', sah: 'Сноуборд хайаларга' } },
  { id: 'v-act-03', tab: 'video', category: 'action',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJNDY3ZTY5MWYtZDEzNy00NjZkLWIzZDQtOTE5NzAyZmMxOGIzLXdXc3pobEREcVpJTDBwdnBIU2hTT1Etb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Боксёр наносит мощный удар по груше в тёмном спортзале, пот разлетается в замедленной съёмке. Драматичное боковое освещение, резкие тени на мускулах. Камера на уровне глаз, малая глубина резкости. Звук удара, покачивание груши. Стиль спортивной документалистики, кинематографическая цветокоррекция',
    label: { ru: 'Боксёрский зал', sah: 'Бокс зала' } },

  // ─── Природа ───
  { id: 'v-nat-01', tab: 'video', category: 'nature',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMDRlNDU0NjUtOTBjOC00NjE0LWE1ZDYtODU0ODViZWQ4Zjg4LTF2VnIyQUVLR05La0djUFRQSnZYYlEtb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Северное сияние танцует над замёрзшим озером в Якутии — яркие зелёные и фиолетовые полотна света. Заснеженная тайга на заднем плане. Таймлапс с плавным движением, сверхширокоугольный объектив. Звёзды отражаются на льду. Кинематографическое 4K, умиротворённое настроение, звук потрескивающего льда',
    label: { ru: 'Северное сияние', sah: 'Хаҕыс сырдыга' } },
  { id: 'v-nat-02', tab: 'video', category: 'nature',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJYzMzMmJiNmMtZTMzYS00NDQ0LTgyZGUtZmNmNWEyMWFjNzE0LTVxS1ZjdFlMd21TeE03U0JNY1hrbmctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Туманное горное озеро на рассвете. Деревянный причал уходит в молочную дымку. Камера медленно наезжает, туман плывёт над водой. Птицы взлетают из-за деревьев. Реалистичные отражения гор в неподвижной воде. Созерцательное настроение, стиль документалистики о природе, мягкий естественный свет',
    label: { ru: 'Туманное озеро', sah: 'Туманнаах күөл' } },

  // ─── Сюрреализм ───
  { id: 'v-sur-01', tab: 'video', category: 'surreal',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMGY4MTMxNWYtMWNiYS00OTY0LWIzNzktNjg5MTU5ZjQ3ODBiLTdXTDFVTnVwWGlIWTF0X2tycVNaTXctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Девушка в белом платье идёт по бесконечной водной глади, где небо сливается с горизонтом — зеркальное отражение. Каждый шаг создаёт расходящиеся круги на воде. Закатное освещение, пастельные розовые и голубые тона. Камера медленно отъезжает. Сюрреалистическая атмосфера, стиль Терренса Малика, созерцательное настроение',
    label: { ru: 'Зеркальная вода', sah: 'Күзүңү уу' } },
  { id: 'v-sur-02', tab: 'video', category: 'surreal',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMDA2ZjQ5MDgtM2JjZS00OWMzLThkN2YtYzc1ZTY5ODkwZTMyLUpaQ016WHFlcjVVUFpoeVFia2NMcUEtb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Мужчина в чёрном пальто стоит посреди пустыни, вокруг него медленно вращаются парящие осколки зеркал. Каждый осколок отражает другую реальность — город, океан, лес, космос. Камера поднимается вверх, открывая масштаб. Золотой закатный свет, тёмные тени. Сюрреалистическая эстетика, стиль Кристофера Нолана',
    label: { ru: 'Осколки реальности', sah: 'Дьиктилик оһуордара' } },

  // ─── Продукт ───
  { id: 'v-prod-01', tab: 'video', category: 'product',
    previewUrl: KL('fQoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpjS2xpbmdBSV9Lb2xvcnNfS29sb3JzLXYzXzAtb21uaS12Mi1pMmktc3ItdmFlX2RfX2U5ZThmMDBmXzAyMzg4ZWE5ODA1NDE4YTk3MzZjYWY0NWE1ZDIyNjkzbDdzd2wucG5n', 720, 1275),
    prompt: 'Флакон духов медленно вращается на чёрном зеркальном подиуме, вокруг — лепестки роз, парящие в воздухе в замедленной съёмке. Драматичная акцентная подсветка: тёплый ключевой свет слева, холодный контровой справа. Капли воды на стекле флакона создают преломления. Премиальная предметная съёмка, 4K, стиль рекламы Chanel',
    label: { ru: 'Люксовый парфюм', sah: 'Люкс парфюм' } },
  { id: 'v-prod-02', tab: 'video', category: 'product',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJMmVkODQ1ZmYtNjI2Zi00YzZiLWI3ZjktZjRmODdiNjNlMzg2LU5jR3E1RlNtVUN3SlU2eThLekFMX0Etb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Чашка горячего кофе на деревянном столе, пар поднимается мягкими завитками. Камера медленно наезжает сверху. На заднем плане — размытое уютное кафе с тёплым освещением. Латте-арт в форме листа на поверхности. Макросъёмка, мягкий боке, тёплая палитра коричневых и кремовых тонов. Предметная фотография, стиль рекламы кофейного бренда',
    label: { ru: 'Утренний кофе', sah: 'Сарсыардааҕы кофе' } },

  // ─── Соцсети ───
  { id: 'v-soc-01', tab: 'video', category: 'social',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJZjQ5NDY4YWEtMzA1Ni00OGNiLWEzMzgtYzE3N2QwMDE1OTEyLTJnd05xZ1Nmd2hlYU9VVlFLUlR0MWctb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Девушка-блогер радостно распаковывает посылку перед камерой, достаёт стильные кроссовки. Выражение восторга, показывает товар со всех сторон. Светлая комната, кольцевой свет, эстетика YouTube-анбоксинга. Вертикальный формат, яркие насыщенные цвета, динамичные переходы между ракурсами, стиль вирусного TikTok-ролика',
    label: { ru: 'Анбоксинг', sah: 'Анбоксинг' } },
  { id: 'v-soc-02', tab: 'video', category: 'social',
    previewUrl: KL('YwoGdXBsb2FkEg55bGFiLXN0dW50LXNncBpJN2ZkODJmN2YtNmYwNS00YjZkLWJjNzQtMjFkMzY1YmJhMzI0LUhKUXhxb3I4NnZrQnlOelNQSnpVU0Etb3V0cHV0X2ZmLmpwZw'),
    prompt: 'Молодой мужчина снимает фуд-контент: красиво раскладывает суши на чёрной тарелке, поливает соевым соусом в замедленной съёмке. Вид сверху, затем переключение на боковой ракурс. Минималистичный тёмный фон, акцентное освещение на еде. Вертикальный формат, ASMR-эстетика, стиль food-блогера',
