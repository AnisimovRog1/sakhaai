...
export const MOTION_TEMPLATES: VideoPromptTemplate[] = [
  { id: 'm-01', tab: 'motion', category: 'all', isVideo: true,
    ...
    prompt: 'Recreate this exact video with the person from my uploaded photo. Replace the face and body with the person in the photo while preserving every movement, gesture, facial expression, timing and choreography from the reference video exactly. Ultra-realistic 4K quality, cinematic natural lighting, lifelike skin texture, sharp fine details. (Outfit and background: keep from the original video, or match clothing and setting from the uploaded photo — user preference)',
