...
export const VIDEO_TEMPLATES: VideoPromptTemplate[] = [
  // ─── Кино ───
  { id: 'v-cine-01', tab: 'video', category: 'cinematic', isVideo: true, previewUrl: MX(42217, 360), posterUrl: MX_POSTER(42217),
    prompt: 'Молодая девушка в лёгком платье медленно поворачивается к камере на фоне золотого заката в поле пшеницы. Тёплый контровой свет, ветер играет с волосами. Крупный план лица, мягкая улыбка, солнечные блики. Кинематографическая малая глубина резкости, цветокоррекция в тёплых тонах, стиль независимого кино. Фотореалистичное качество 4K',
  ...
  { id: 'v-cine-02', tab: 'video', category: 'cinematic', isVideo: true, previewUrl: MX(4034, 360), posterUrl: MX_POSTER(4034),
    prompt: 'Солнечная прибрежная трасса с крутыми скалами и сверкающим океаном. Золотой час, длинные тени. Элегантный красный кабриолет едет на умеренной скорости. Камера сопровождает автомобиль, затем отъезжает, открывая береговую линию. Кинематографическое 4K, малая глубина резкости, насыщенная цветокоррекция. Реалистичный водитель за рулём',
  ...
  { id: 'v-cine-03', tab: 'video', category: 'cinematic', isVideo: true, previewUrl: MX(9582, 360), posterUrl: MX_POSTER(9582),
    prompt: 'Крупный план: капли дождя бьют по оконному стеклу, за которым размыты городские огни. Молодая женщина с задумчивым лицом отражается в стекле. Малая глубина резкости, янтарный свет. Замедленная съёмка потоков воды. Меланхоличная кинематографическая атмосфера, ночной город, звуковой дизайн ASMR',
  ...
  { id: 'v-cine-04', tab: 'video', category: 'cinematic', isVideo: true, previewUrl: MX(4075, 360), posterUrl: MX_POSTER(4075),
    prompt: 'Мужчина в тёмном костюме стоит на крыше небоскрёба, ветер развевает полы пиджака. Ночной мегаполис сияет огнями внизу. Камера медленно облетает вокруг, открывая панораму. Неоновые отражения на мокром асфальте. Кинематографический стиль нуар, синяя и оранжевая цветокоррекция, 4K',
    label: { ru: 'Ночной город', sah: 'Түүн куорат' } },
  { id: 'v-cine-05', tab: 'video', category: 'cinematic', isVideo: true, previewUrl: MX(9808524, 360), posterUrl: MX_POSTER(9808524),
    prompt: 'Пара танцует медленный танец в пустом бальном зале с хрустальной люстрой. Мягкий рассеянный свет, пылинки в воздухе. Камера отъезжает, показывая масштаб зала. Элегантное вечернее платье развевается при вращении. Романтическая кинематография, стиль «Ла-Ла Ленд», тёплая золотая палитра, реалистичные лица',
  ...
  { id: 'v-act-01', tab: 'video', category: 'action', isVideo: true, previewUrl: MX(5961, 360), posterUrl: MX_POSTER(5961),
    prompt: 'Паркурщик бежит по краю крыши, прыжок через пропасть между зданиями. Камера летит следом в стиле FPV-дрона. Замедленная съёмка в полёте, ускорение при приземлении. Утренний туман, контровой свет. Реалистичный человек, анатомически точные движения, динамичная спортивная кинематография 4K',
  ...
  { id: 'v-act-02', tab: 'video', category: 'action', isVideo: true, previewUrl: MX(41576, 360), posterUrl: MX_POSTER(41576),
    prompt: 'Сноубордист летит по свежему пухляку в горах, шлейф снежной пыли. Вид от первого лица, переключение на боковую камеру. Яркое солнце, белоснежные склоны. Замедленная съёмка прыжка с трамплина. Реалистичный человек в экипировке, GoPro-эстетика, экстремальная спортивная съёмка',
  ...
  { id: 'v-act-03', tab: 'video', category: 'action', isVideo: true, previewUrl: MX(40985, 360), posterUrl: MX_POSTER(40985),
    prompt: 'Боксёр наносит мощный удар по груше в тёмном спортзале, пот разлетается в замедленной съёмке. Драматичное боковое освещение, резкие тени на мускулах. Камера на уровне глаз, малая глубина резкости. Реалистичное тело, капли пота на коже, стиль спортивной документалистики',
  ...
  { id: 'v-nat-01', tab: 'video', category: 'nature', isVideo: true, previewUrl: MX(4038, 360), posterUrl: MX_POSTER(4038),
    prompt: 'Северное сияние танцует над замёрзшим озером в Якутии — яркие зелёные и фиолетовые полотна. Заснеженная тайга на заднем плане. Таймлапс, сверхширокоугольный объектив. Звёзды отражаются на льду. Одинокая фигура человека на берегу смотрит вверх. Кинематографическое 4K, умиротворённое настроение',
  ...
  { id: 'v-nat-02', tab: 'video', category: 'nature', isVideo: true, previewUrl: MX(2213, 360), posterUrl: MX_POSTER(2213),
    prompt: 'Туманное горное озеро на рассвете. Деревянный причал уходит в дымку. Камера медленно наезжает, туман плывёт. Рыбак в лодке забрасывает удочку. Реалистичные отражения гор, созерцательное настроение, стиль документалистики, мягкий естественный свет',
  ...
  { id: 'v-nat-03', tab: 'video', category: 'nature', isVideo: true, previewUrl: MX(4040, 360), posterUrl: MX_POSTER(4040),
    prompt: 'Девушка в тёплой куртке стоит на вершине горы, ветер развевает волосы. Камера облетает вокруг неё, открывая панораму заснеженных хребтов. Золотой час, облака ниже уровня, эпический масштаб. Фотореалистичная детализация, кинематографический широкий план',
    label: { ru: 'Вершина горы', sah: 'Хайа тюсюлгэтэ' } },

  // ─── Сюрреализм ───
  { id: 'v-sur-01', tab: 'video', category: 'surreal', isVideo: true, previewUrl: MX(14555, 360), posterUrl: MX_POSTER(14555),
    prompt: 'Девушка в белом платье идёт по бесконечной водной глади, небо сливается с горизонтом — зеркальное отражение. Каждый шаг создаёт круги на воде. Закатные пастельные розовые и голубые тона. Камера медленно отъезжает. Сюрреалистическая атмосфера, стиль Терренса Малика, фотореализм',
  ...
  { id: 'v-sur-02', tab: 'video', category: 'surreal', isVideo: true, previewUrl: MX(4036, 360), posterUrl: MX_POSTER(4036),
    prompt: 'Мужчина в чёрном пальто стоит посреди пустыни, вокруг медленно вращаются парящие осколки зеркал. Каждый осколок отражает другую реальность — город, океан, космос. Камера поднимается вверх. Золотой закатный свет, тёмные тени. Реалистичное лицо, сюрреалистическая эстетика Кристофера Нолана',
  ...
  { id: 'v-prod-01', tab: 'video', category: 'product', isVideo: true, previewUrl: MX(50417, 360), posterUrl: MX_POSTER(50417),
    prompt: 'Флакон духов медленно вращается на чёрном зеркальном подиуме, лепестки роз парят в воздухе в замедленной съёмке. Тёплый ключевой свет слева, холодный контровой справа. Капли воды на стекле создают преломления. Рука модели с идеальным маникюром берёт флакон. Премиальная съёмка 4K, стиль Chanel',
  ...
  { id: 'v-prod-02', tab: 'video', category: 'product', isVideo: true, previewUrl: MX(50423, 360), posterUrl: MX_POSTER(50423),
    prompt: 'Бариста с татуировками на руках наливает латте-арт — тонкая струя молока рисует лист на поверхности. Макросъёмка, мягкий боке. Затем камера отъезжает, показывая уютное кафе с тёплым освещением. Пар поднимается мягкими завитками. ASMR-эстетика, стиль рекламы кофейного бренда',
  ...
  { id: 'v-soc-01', tab: 'video', category: 'social', isVideo: true, previewUrl: MX(6102, 360), posterUrl: MX_POSTER(6102),
    prompt: 'Девушка-блогер радостно распаковывает посылку перед камерой, достаёт кроссовки. Выражение восторга, показывает со всех сторон. Кольцевой свет, эстетика YouTube. Вертикальный формат, яркие цвета, динамичные переходы, стиль вирусного TikTok. Реалистичное лицо с эмоциями',
  ...
  { id: 'v-soc-02', tab: 'video', category: 'social', isVideo: true, previewUrl: MX(235, 360), posterUrl: MX_POSTER(235),
    prompt: 'Молодой шеф-повар красиво раскладывает суши на чёрной тарелке, поливает соевым соусом в замедленной съёмке. Вид сверху, затем боковой ракурс. Тёмный фон, акцентное освещение. Реалистичные руки с деталями, ASMR-эстетика, вертикальный формат для TikTok, стиль food-блогера',
