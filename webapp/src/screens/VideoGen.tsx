        ...
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-white text-[11px] leading-snug px-1">
              {motionOrient === 'video'
                ? 'Загрузи своё фото и видео с движениями — персонаж будет двигаться точно так же. Идеально для танцев в Reels, трендов TikTok, спортивных движений и жестов.'
                : 'Персонаж остаётся на месте, а камера красиво двигается вокруг него — приближается, облетает, отдаляется. Идеально для рекламы, презентаций и кинематографичных кадров.'}
            </p>
          </div>
