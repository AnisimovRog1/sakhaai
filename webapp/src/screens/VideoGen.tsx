      ...
      {tab === 'motion' && (
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-white text-[11px] leading-snug px-1 whitespace-pre-line">
              {motionOrient === 'video'
                ? 'Загрузи своё фото и видео с движениями - персонаж будет двигаться точно так же.\nИдеально для танцев Reels, трендов TikTok, спортивных движений и жестов.'
                : 'Персонаж остаётся на месте, а камера красиво двигается вокруг него - приближается, облетает, отдаляется.\nИдеально для рекламы, презентаций и кинематографичных кадров.'}
            </p>
          </div>
